...
function ExerciceCard() {
    return <div className="card w-full bg-base-100 border-2">
        <div className="card-body">
            <h2 className="card-title">Résoudre des équations simples</h2>
            <p>Une équation est une égalité entre deux expressions mathématiques. Les équations peuvent être
                résolues en
                utilisant des méthodes d'algèbre.</p>
            <div className="card-actions">
                <button className="btn btn-primary btn-xs">Accéder à l'exercice</button>
            </div>
        </div>
    </div>
}
